...
function initialize() {
    ...
    function checkBoxes(e) {
        e.preventDefault();
        requirements = majors["Mathematics"].reqlist;
        reqsDone = {};
    ...
    function updateDisplay() {
        ...
        unfilled = {};
        reqDescription = majors["Mathematics"].reqdict;
