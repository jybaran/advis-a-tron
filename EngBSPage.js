...
function initialize() {
    ...
    function showMajor() {
        ...
        major.textContent = "Department: Engineering BS";
        let advisors = majors["Engineering BS"].advisors;
        advisorsList.textContent = "";
        for (let advisor of advisors) {
            advisorsList.textContent = advisorsList.textContent.concat(advisor, ", ");
        }
        courses = majors["Engineering BS"].courses;
    ...
    function checkBoxes(e) {
        e.preventDefault();
        requirements = majors["Engineering BS"].reqlist;
        reqsDone = {};
    ...
    function updateDisplay() {
        ...
        unfilled = {};
        reqDescription = majors["Engineering BS"].reqdict;
