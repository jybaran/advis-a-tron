...
function initialize() {
    ...
    function checkBoxes(e) {
        e.preventDefault();
        requirements = majors["Astronomy"].reqlist;
        reqsDone = {};
    ...
    function updateDisplay() {
        ...
        unfilled = {};
        reqDescription = majors["Astronomy"].reqdict;
